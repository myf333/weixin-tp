...
import com.myf.weixin.model.GrantUserInfoRet;
import com.myf.weixin.model.OAuthAccessTokenResult;
import com.myf.weixin.model.Scope;
...
public class OauthService {
     ...
     * **/
    public String getAuthorizeUrl(String appId, String redirect_uri, Scope scope, String state)throws Exception{
     ...
     * **/
    public OAuthAccessTokenResult getAccessToken(String appId, String appSecret, String code)throws Exception{
     ...
     * **/
    public OAuthAccessTokenResult refreshAccessToken(String appId,String refresh_token)throws Exception{
     ...
     * **/
    public WxJsonResult checkAccessToken(String access_token, String openId)throws Exception{
     ...
     * **/
    public GrantUserInfoRet getUserInfo(String access_token, String openId)throws Exception{
